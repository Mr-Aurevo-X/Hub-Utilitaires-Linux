...
class ImagesPage:
    ...
    def _build(self) -> Gtk.Widget:
        ...
        self._files_count = Gtk.Label(xalign=0)
        box.append(self._files_count)
        ...
        box.append(common.t_label("resize_info", xalign=0))
    ...
    def _set_files(self, paths: list[Path]) -> None:
        ...
        self._files_count.set_text(i18n.t("files_count", count=len(paths)))
        if not paths:
