...
class PdfPage:
    ...
    def _build(self) -> Gtk.Widget:
        ...
        common.padded(box)
        hint = common.t_label("pdf_hint", wrap=True, xalign=0)
        ...
        up = common.t_button("pdf_up")
        down = common.t_button("pdf_down")
        ...
        self._ranges = common.t_entry("pdf_ranges")
        box.append(self._ranges)
        self._password = common.t_entry("pdf_password")
        self._password.set_visibility(False)
        box.append(self._password)
        self._blank = Gtk.SpinButton.new_with_range(0, 999, 1)
        box.append(common.t_label("pdf_blank", xalign=0))
        box.append(self._blank)
        box.append(common.t_label("pdf_rotate", xalign=0))
    ...
    def _refresh_list(self) -> None:
        common.fill_path_list(self._list, self._files, numbered=True)
        self._files_count.set_text(i18n.t("files_count", count=len(self._files)))
